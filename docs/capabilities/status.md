...
|---|---:|---|
| `kernel-tested` | 7 | Deterministic domain/provider capability with offline contract evidence; provider entries may be dormant or indirect. |
| `agent-exposed` | 6 | Available through a declared Skill, tool, or preset and covered by composition/isolation contracts. |
