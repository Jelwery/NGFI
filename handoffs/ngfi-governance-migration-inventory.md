...
| `packages/finance-core/src/data-v2/**`, `packages/finance-data-service/**` | same | 2.1 | untracked plus export edit | no | data-v2/service/reconciliation tests | no | pending |
