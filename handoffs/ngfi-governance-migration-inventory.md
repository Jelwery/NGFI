...
| `packages/finance-provider-astock/**`, `packages/finance-provider-{cne6,ifind,tdx,tushare-mcp}/**`, `skills/a-share-data-research/**`, A-share tests/fixtures/workflow/notices | same | 2.2 | untracked | generated upstream snapshot only where manifest-governed | upstream/license/security/provider tests | no | migrated |
