...
| `packages/dsh-finance-tools/**`, `packages/dsh-finance-bundle/**`, presets, composition/isolation/E2E tests | reviewed thin adapters and generated presets | 3–4 | mixed | preset output only | build/typecheck/composition/isolation/trajectory | no | Phase 3 adapter/preset governance migrated; Phase 4 tool surface pending |
