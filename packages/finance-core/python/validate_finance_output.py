#!/usr/bin/env python3
"""Offline import validator for legacy intrinsic-only reports/state, not ledger audit.

Price comparisons in normal valuation-first research belong to a separately
audited ledger/memo; this validator deliberately retains the stricter contract.
"""
...
def main() -> int:
    ...
    parser.add_argument("--mode", choices=("intrinsic-only",), default="intrinsic-only",
                        help="Offline legacy import contract; valuation-first comparisons require ledger audit")
